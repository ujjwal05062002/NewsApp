                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form className="d-flex" role="search" onSubmit={(e)=>this.postSearch(e)}>
                                <input className="form-control me-2" onChange={(e) =>this.setState({search:e.target.value})} type="search" name='search' placeholder="Search"value={this.state.search} aria-label="Search" />
